...
NDefines.NDiplomacy.PO_FORM_PU_AE = 0.00001 							-- _DDEF_PO_FORM_PU_AE = 10, (Per development)
...
NDefines.NEconomy.AUTONOMY_AT_DIPLO_ANNEX = 50					-- Autonomy added when diplo-annexing
